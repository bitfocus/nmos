...
exports.default = zod_1.z
    ...
    format: zod_1.z.literal('urn:x-nmos:format:data').describe('Type of Flow accepted by the Receiver as a URN'),
    caps: zod_1.z
        .object({
        media_types: zod_1.z
            .array(zod_1.z.union([zod_1.z.enum(['video/smpte291', 'application/json']), zod_1.z.any()]))
            .min(1)
