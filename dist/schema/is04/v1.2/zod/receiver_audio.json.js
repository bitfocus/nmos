...
exports.default = zod_1.z
    ...
    format: zod_1.z.literal('urn:x-nmos:format:audio').describe('Type of Flow accepted by the Receiver as a URN'),
    caps: zod_1.z
        .object({
        media_types: zod_1.z
            .array(zod_1.z.union([zod_1.z.enum(['audio/L24', 'audio/L20', 'audio/L16', 'audio/L8']), zod_1.z.any()]))
            .min(1)
