    ...
    const schemas = [
        ...
        zod_1.z
            ...
            zod_1.z
                ...
                colorspace: zod_1.z
                    .union([
                    zod_1.z.enum(['BT601', 'BT709', 'BT2020', 'BT2100']),
                    zod_1.z.any(),
                ])
            ...
            zod_1.z
                ...
                media_type: zod_1.z
                    .any()
                    .refine((value) => !zod_1.z.enum(['video/smpte291', 'application/json']).safeParse(value)
            ...
            const schemas = [
                ...
                zod_1.z
                    ...
                    caps: zod_1.z
                        ...
                        media_types: zod_1.z
                            .array(zod_1.z.union([
                            zod_1.z.enum(['video/smpte291', 'application/json']),
                            zod_1.z.any(),
                        ]))
                            .min(1)
                            .describe('Subclassification of the formats accepted using IANA assigned media types')
