...
declare const _default: z.ZodIntersection<z.ZodRecord<z.ZodString, z.ZodAny>, z.ZodIntersection<z.ZodIntersection<z.ZodRecord<z.ZodString, z.ZodAny>, z.ZodIntersection<z.ZodObject<{
    ...
    format: z.ZodEnum<["urn:x-nmos:format:video", "urn:x-nmos:format:data", "urn:x-nmos:format:mux"]>;
}, "strip", z.ZodTypeAny, {
    format: "urn:x-nmos:format:video" | "urn:x-nmos:format:data" | "urn:x-nmos:format:mux";
}, {
    format: "urn:x-nmos:format:video" | "urn:x-nmos:format:data" | "urn:x-nmos:format:mux";
}>>>;
