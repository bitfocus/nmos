...
exports.default = {
    '/node/v1.1/self': node_json_1.default,
    '/node/v1.1/devices': devices_json_1.default,
    '/node/v1.1/devices/{device_id}': device_json_1.default,
    '/node/v1.1/senders': senders_json_1.default,
    '/node/v1.1/senders/{sender_id}': sender_json_1.default,
    '/node/v1.1/receivers': receivers_json_1.default,
    '/node/v1.1/receivers/{receiver_id}': receiver_json_1.default,
    '/node/v1.1/sources': sources_json_1.default,
    '/node/v1.1/sources/{source_id}': source_json_1.default,
    '/node/v1.1/flows': flows_json_1.default,
    '/node/v1.1/flows/{flow_id}': flow_json_1.default,
};
