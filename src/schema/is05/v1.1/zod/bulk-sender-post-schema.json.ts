...
export default z
	.array(
		z
			.object({
				id: idPrimitive
					.describe('ID of the target sender to apply parameters to'),
				params: z
					.object({
						receiver_id: z
							.union([
									...
									z
										.object({
											...
											fec_type: z
												...
												.describe('forward error correction mode to apply')
												.optional(),
	...
	.describe('Describes a bulk sender update resource')
