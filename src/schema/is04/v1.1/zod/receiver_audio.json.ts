...
export default z
	...
	.and(
		z.intersection(
			...
			z.object({
				format: z.literal('urn:x-nmos:format:audio').describe('Type of Flow accepted by the Receiver as a URN'),
				caps: z
					.object({
						media_types: z
							.array(z.union([z.enum(['audio/L24', 'audio/L20', 'audio/L16', 'audio/L8']), z.any()]))
							.min(1)
