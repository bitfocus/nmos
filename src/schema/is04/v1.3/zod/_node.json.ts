...
import { _macAdressPrimitive, versionPrimitive } from './_primitives'

export const _endpoints = z
	.array(
		z.object({
			host: z
...
export const _nodeInterfaces = z
	.array(
		z.object({
			chassis_id: _nodeChassisId
				.describe(
...
export const nodeApiVersion = z.union([
	z.literal('v1.0'),
	z.literal('v1.1'),
	z.literal('v1.2'),
	z.literal('v1.3'),
...
export default
	_nmosResourceBase.and(
		z.object({
			...
			api: z
				.object({
					versions: z.array(nodeApiVersion)
