...
const _sender = _nmosResourceBase
	.and(
		z.object({
			...
			transport: transportUrn.describe('Transport type used by the Sender in URN format'),
...
export type SenderBaseView = z.infer<typeof _sender>
