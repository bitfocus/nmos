...
const _receiverDataCaps = z.object({
	media_types: z
...
export const _receiverDataCore = z.object({
	format: z.literal('urn:x-nmos:format:data').describe('Type of Flow accepted by the Receiver as a URN'),
	caps: _receiverDataCaps.describe('Capabilities'),
})
