...
import { _deviceControlsItemWithAuth as _deviceControlsItemWithoutAuth } from './_controls'
...
export default _nmosResourceBase
	.and(
		z.object({
			...
			controls: z.array(_deviceControlsItemWithoutAuth).describe('Control endpoints exposed for the Device'),
		}),
	)
