/**
 * Common base code for Generated APIs.
 * This is based on the output of `@openapitools/openapi-generator-cli`, but simplified
 */

export const BASE_PATH = "http://api.example.com/x-nmos".replace(/\/+$/, "");
